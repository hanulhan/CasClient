...
public class Cas20ProxyReceivingTicketValidationFilter extends AbstractTicketValidationFilter {
    ...
    protected void initInternal(final FilterConfig filterConfig) throws ServletException {
        ...
        logger.debug("##UH## - Cas20ProxyReceivingTicketValidationFilter.initInternal()");
    ...
    public void init() {
        ...
        logger.debug("##UH## - Cas20ProxyReceivingTicketValidationFilter.init()");
    ...
    protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
        ...
        logger.debug("##UH## - Cas20ProxyReceivingTicketValidationFilter.getTicketValidator()");
    ...
    protected final boolean preFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
        ...
        logger.debug("##UH## - Cas20ProxyReceivingTicketValidationFilter.preFilter()");
        if (CommonUtils.isEmpty(this.proxyReceptorUrl) || !requestUri.endsWith(this.proxyReceptorUrl)) {
            logger.debug("##UH## - proxyReceptorUrl: " + proxyReceptorUrl);
            logger.debug("##UH## - requestUri: " + requestUri);
            return true;
        }
    ...
    public final void setProxyReceptorUrl(final String proxyReceptorUrl) {
        logger.debug("##UH## - setProxyReceptorUrl(" + proxyReceptorUrl + ")");
