...
public final class SingleSignOutFilter extends AbstractConfigurationFilter {
    ...
    public void init(final FilterConfig filterConfig) throws ServletException {
        ...
        logger.debug("##UH## - SingleSignOutFilter.init()");
    ...
    public void setArtifactParameterName(final String name) {
        logger.debug("##UH## - SingleSignOutFilter.setArtifactParameterName(" + name + ")");
        HANDLER.setArtifactParameterName(name);
        
    }

    public void setLogoutParameterName(final String name) {
        logger.debug("##UH## - SingleSignOutFilter.setLogoutParameterName(" + name + ")");
        HANDLER.setLogoutParameterName(name);
        
    }

    public void setFrontLogoutParameterName(final String name) {
        logger.debug("##UH## - SingleSignOutFilter.setFrontLogoutParameterName(" + name + ")");
        HANDLER.setFrontLogoutParameterName(name);
    }

    public void setRelayStateParameterName(final String name) {
        logger.debug("##UH## - SingleSignOutFilter.setRelayStateParameterName(" + name + ")");
        HANDLER.setRelayStateParameterName(name);
    }

    public void setCasServerUrlPrefix(final String casServerUrlPrefix) {
        logger.debug("##UH## - SingleSignOutFilter.setCasServerUrlPrefix(" + casServerUrlPrefix + ")");
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
        ...
        logger.debug("##UH## - SingleSignOutFilter.doFilter()");
        /**
